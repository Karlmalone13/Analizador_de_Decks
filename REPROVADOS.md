...
| Diagnosticar divergencia ao vivo x offline sem abrir o log bruto do que a acao ao vivo FEZ | 2 blocos atras de "por que o motor offline nao ativa o Mihawk" (heuristica filtrando, depois "Q perde por pouco"); o log mostrava 3 de 4 ativacoes ao vivo desvirando **0 DON** -- o erro era ao vivo. Alem disso, `_am_debug` so loga RECUSAS: contar so ele pinta "nunca vira candidata" | 893, 894 -> 895 |
