# TODO — ARQUIVO HISTÓRICO

> Separado do [`TODO.md`](TODO.md) em **12/09/2026 (bloco 780)**, a pedido do
> usuário, na revisão das regras do projeto.
>
> **Motivo**: o `TODO.md` tinha 10.248 linhas, das quais 48 seções já
> fechadas (🟢/✅) e centenas de entradas de bloco de julho/agosto. A regra
> do projeto diz que ele é **lista viva** — e na prática ele tinha virado um
> segundo `HANDOFF.md`, com os itens realmente abertos enterrados no meio de
> meses de histórico.
>
> **O que está aqui**: entradas de bloco de **agosto/2026 para trás** e todas
> as seções por tópico já concluídas. **Nada foi apagado** — só movido.
>
> **O que NÃO está aqui**: o que continua aberto. Isso ficou no `TODO.md`,
> triado item a item.
>
> ⚠️ **Uma seção deste arquivo está factualmente SUPERADA e não deve ser
> seguida**: o "PLANO MESTRE DE EVOLUÇÃO DO MOTOR" (13/07/2026) diz
> *"ML/MCTS descartados por ora"* e estava marcado **LER PRIMEIRO**. A
> direção oficial desde **10/09/2026** é a inversa — substituir a heurística
> pelo ML por partes, por decisão explícita do usuário. Ver `CLAUDE.md`,
> seção "DIREÇÃO OFICIAL".
