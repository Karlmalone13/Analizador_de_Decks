...
def derive_analysis(card_text: str, card_type: str, counter: int) -> dict:
    ...
    # trash_character/ko_selected/opp_bounce_own_character: mesma mecanica
    # de remocao de campo que 'ko'/'bounce' (achados 24/07, fase 2 do
    # mapeamento de combos -- 1a e 2a passada -- poucas cartas no banco,
    # mas ficavam invisiveis pro mesmo bonus de is_removal que ko/bounce
    # ja tem).
